...
def get_permissions(file_path):
	...
	permission_string = ""
	permission_string += "r" if (mode & 0o400) else "-"
	permission_string += "w" if (mode & 0o200) else "-"
	permission_string += "x" if (mode & 0o100) else "-"
	permission_string += "r" if (mode & 0o040) else "-"
	permission_string += "w" if (mode & 0o020) else "-"
	permission_string += "x" if (mode & 0o010) else "-"
	permission_string += "r" if (mode & 0o004) else "-"
	permission_string += "w" if (mode & 0o002) else "-"
	permission_string += "x" if (mode & 0o001) else "-"
